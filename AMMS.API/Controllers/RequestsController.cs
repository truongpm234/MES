...
namespace AMMS.API.Controllers
{
    ...
    public class RequestsController : ControllerBase
    {
        ...
        //[FromBody] PayOsWebhookDto payload,
        ...
        //        return Ok(new { ok = true, converted = convert.Success, convertMessage = convert.Message });
        //    }

        [HttpPost("/api/payos/webhook")]
        public async Task<IActionResult> PayOsWebhook([FromBody] JsonElement raw)
        {
            Console.WriteLine("====== PAYOS WEBHOOK RAW START ======");
            Console.WriteLine(raw.ToString());
            Console.WriteLine("====== PAYOS WEBHOOK RAW END ======");
